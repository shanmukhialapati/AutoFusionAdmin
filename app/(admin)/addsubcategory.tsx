...
export default function AddSubCategoryScreen() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      console.log('🚀 Sending Multipart POST to /subcategories...');
      ...
      console.log('✅ Created Subcategory:', JSON.stringify(res.data));
      router.back();

    } catch (e: any) {
      const errorData = e?.response?.data;
      const msg = typeof errorData === 'string' ? errorData : errorData?.message || e?.message || 'Failed to create subcategory';
          ...
          >
            ...
            <View style={styles.cardHeader}>
              <View style={styles.brandContainer}>
                ...
                <Text style={styles.cardTitle}>Add Sub Category</Text>
              </View>
              ...
              <View style={styles.formFields}>
                ...
                >
                  {loading ? (
                    ...
                    <Text style={styles.submitBtnText}>Save Sub Category</Text>
                  )}
                </TouchableOpacity>
              </View>
            </View>

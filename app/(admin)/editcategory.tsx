...
export default function EditCategoryScreen() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      console.log(`🚀 Sending Multipart PUT to /categories/${id}...`);
      ...
      console.log('✅ Updated Category:', JSON.stringify(res.data));
      router.back();

    } catch (e: any) {
      const errorData = e?.response?.data;
      const msg = typeof errorData === 'string' ? errorData : errorData?.message || e?.message || 'Failed to update category';

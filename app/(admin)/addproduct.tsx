...
export default function AddProductScreen() {
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            // 1. Create the product object to match Postman
            const productData = {
                name: name.trim(),
            ...
            if (Platform.OS === 'web') {
                ...
                formData.append('file', new File([imageBlob], 'product.jpg', { type: 'image/jpeg' }));
            } else {
            ...
            console.log('✅ Created Product:', JSON.stringify(res.data));
            router.back();

        } catch (e: any) {
            const errorData = e?.response?.data;
            const msg = typeof errorData === 'string' ? errorData : errorData?.message || e?.message || 'Failed to create product';
                        ...
                        <View style={styles.cardHeader}>
                            <View style={styles.brandContainer}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.cardSubtitle}>STAGING // NEW_ENTITY</Text>
                                </View>
                            </View>
